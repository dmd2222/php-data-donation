# php-data-donation
php-data-donation: Write log of POST data and send an email if wanted.




# Features
- write POST-data into log.
- secure file agains reading.
- ip-ddos protection
- send email if wanted with the data


# Installation
- Copy the code in your ftp folder. (Ready to use. :) )
- <code> git clone https://github.com/dmd2222/php-data-donation.git <code>
- Optional: change options in the beginning of the main file.

  # Using

  Send POST request to your url.
  Tip: use POSTMAN to test
  or
  Online tool: https://reqbin.com/
